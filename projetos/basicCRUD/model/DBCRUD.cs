    ...
    class DBCRUD : Program 
    {
        ...
        public void Read()
        {
            ...
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                var pessoas = connection.Query<TablePessoas>(sql);
        ...
        public void Create()
        {
            ...
            Console.WriteLine("");
            Console.WriteLine("Digite seu telefonte: ");
        ...
        public void Update()
        {
            ...
            {
                case "0": Menu(); break;
                case "1": sqlUpdate = "UPDATE [pessoas] SET [nome] = @nome WHERE [cpf] = @cpf"; parametrosUpdate = new { nome = ) break;
                case "2": crud.Update(); break;
                case "3": crud.Delete(); break;
                case "4": crud.ReadOne(); break;
                case "5": crud.ReadOne(); break;
                case "6": crud.ReadOne(); break;
                default:
                    Console.WriteLine("");
            ...
            if (res == "0")
            {
                ...
                {
                    //cria a query na conexao, aponta pro objeto Category
                    var rows = connection.Execute(sqlUpdate, parametrosSQL);
                    Console.WriteLine($"{rows} registro excluído com sucesso!");
